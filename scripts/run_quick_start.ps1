...
python .\experiments\ch1\1.1_perceptron_linear_classifier.py --epochs 50 --lr 0.01

Write-Host "[3/4] Running Chapter 1 Experiment 1.2"
python .\experiments\ch1\1.2_three_layer_neural_network_backprop.py --epochs 2500 --lr 0.5
